...
def TakeImages():
    ...
    name = (txt2.get())
     ...
     # Check for duplicate ID and name entries
    with open("StudentDetails\\StudentDetails.csv", 'r') as csvFile:
        reader = csv.reader(csvFile)
        for row in reader:
            if row and (row[2] == Id or row[4] == name):  # checking ID and Name columns
                mess._show(title='Duplicate Entry', message='ID or Name already exists. Please use unique ID and Name.')
                return  # Exit function if a duplicate is found
        
    if ((name.isalpha()) or (' ' in name)):
        cam = cv2.VideoCapture(0)
        if not cam.isOpened():
            mess._show(title='Camera Error', message='Camera not detected. Please connect a camera.')
            return
...
window.title("Smart Attend")
window.configure(background='#7AB2B2')
...
frame1.place(relx=0.1, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#B7E0FF")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Smart Attend" ,fg="black",bg="#EDDFE0" ,width=55 ,height=1,font=('Algerian', 29, ' bold '))
message3.place(x=10, y=10)

datef = tk.Label(window, text=day + "-" + mont[month] + "-" + year, fg="black", bg="#E7CCCC",
                 width=20, font=('Arial Narrow', 15, ' bold '))
datef.pack(fill='both', expand=True)
datef.place(relx=0.30, rely=0.09)

clock = tk.Label(window, fg="black", bg="#E7CCCC", width=20, font=('comic', 15, ' bold '))
clock.place(relx=0.50, rely=0.09)
tick()

head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="black",bg="white" ,font=('comic', 17, ' bold ') )
head2.place(x=0,y=-5)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="black",bg="white" ,font=('comic', 17, ' bold ') )
head1.place(x=0,y=-5)

lbl = tk.Label(frame2, text="Enter ID",width=20  ,height=1  ,fg="black"  ,bg="#B7E0FF" ,font=('comic', 17, ' bold ') )
lbl.place(x=30, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('comic', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="black"  ,bg="#B7E0FF" ,font=('comic', 17, ' bold '))
lbl2.place(x=30, y=140)

txt2 = tk.Entry(frame2,width=32 ,fg="black",font=('comic', 15, ' bold ')  )
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile" ,bg="#B7E0FF" ,fg="black"  ,width=39 ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="#B7E0FF" ,fg="black"  ,width=39,height=1, activebackground = "white" ,font=('comic', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="ATTENDANCE TABLE",width=20  ,fg="black"  ,bg="#B7E0FF"  ,height=1 ,font=('comic', 15, 'underline'))
lbl3.place(x=100, y=170,)
...
tv.grid(row=2,column=0,padx=(0,0),pady=(200,0),columnspan=4)
...
clearButton = tk.Button(frame2, text="Clear", command=clear  ,fg="black"  ,bg="#CE2029"  ,width=11 ,activebackground = "#FFA07A" ,font=('comic', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2  ,fg="black"  ,bg="#CE2029"  ,width=11 , activebackground = "#FFA07A" ,font=('comic', 11, ' bold '))
clearButton2.place(x=335, y=172)    
takeImg = tk.Button(frame2, text="Take Images", command=TakeImages  ,fg="black"  ,bg="#E6E6FA"  ,width=34  ,height=1, activebackground = "#452c63" ,font=('comic', 15, ' bold '))
takeImg.place(x=30, y=300)
trainImg = tk.Button(frame2, text="Save Profile", command=psw ,fg="black"  ,bg="#E6E6FA"  ,width=34  ,height=1, activebackground = "#452c63" ,font=('comic', 15, ' bold '))
...
def send_email():
    ...
    from_email = "jha909abhijeet@gmail.com" 
    password = "vqbu zjrd numu bwcp"  
...
recipient_email_label = tk.Label(frame1, text="Recipient's Email", width=31, fg="black", bg="yellow",
                                  font=('comic', 9, ' bold '))
...
domain_label = tk.Label(frame1, text="Domain:", width=20, fg="black", bg="yellow",
                                  font=('comic', 9, ' bold '))
...
send_email_button = tk.Button(frame1, text="SendAttendance", command=send_email, fg="black", bg="sky blue", width=12,height=1,
...
delete_registration_button = tk.Button(frame1, text="Delete Registration CSV", command=delete_registration_csv, fg="white", bg="purple", width=19, font=('comic', 9, 'bold'))
delete_registration_button.place(x=5, y=85)

delete_attendance_button = tk.Button(frame1, text="Delete Attendance CSV", command=delete_attendance_csv, fg="black", bg="white", width=19, font=('comic', 9, 'bold'))
...
delete_images_button.place(x=2, y=120)
